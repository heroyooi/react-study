...
import { setHpPnFormat, rtnBirthText } from '@src/utils/MemberUtil';
...
//mobile
import { SECTION_MEMBER, MOBILE_FULLPAGE_CPOPUP, MOBILE_FULLPAGE_CPOPUP_CLOSE } from '@src/actions/types';
 ...
 * @return {JoinBaseInfo}
 */
const JoinBaseInfo = ({ mbInfo, onChange, msgObj, onBlur, mbTpcd, onClick, resetFlag }) => {
  ...
  if (hasMobile) {
    ...
    return (
      <>
              ...
              <>
                <tr>
                  <td>
                    ...
                    <Input type="text" value={mbInfo.mbNm} disabled={true} id="m-user-name" height={40} />
                  </td>
                </tr>
                <tr>
                  <td>
                    <p className="tx-tit">생년월일</p>
                    {rtnBirthText(mbInfo?.birth, mbInfo?.genderNo)}
                  </td>
                </tr>
                <tr>
                  <td>
                    ...
                    <span className="bridge2">
                      <Input type="text" value={setHpPnFormat(mbInfo.mbHpPnEnc)} disabled={true} id="m-user-phone" height={40} />
                    </span>
                  </td>
                </tr>
                <tr>
                  <td>
                    ...
                    <Input type="text" id="m-user-email1" height={40} width="46%" maxLength={50} name="mbEmlAddr" onChange={onHandleChange} onBlur={onHandleBlur} />
                    <span className="ml8 mr8">@</span>
                    <Input type="text" id="m-user-email2" height={40} width="45%" maxLength={50} name="mbEmlAddrDomain" onChange={onHandleChange} onBlur={onHandleBlur} value={mbEmlAddrDomain} />
                    <div className="mt8">
                      <MobSelectList
        ...
        <MobFullpagePopup active={mFullpageCPopup} cPop={true} subPop={true}>{fpAddress && <FindAddress AddressEvent={AddressCallback} />}</MobFullpagePopup>
      </>
    );
  }
  //pc
          ...
          {viewFlag && (
            <>
              ...
              <tr>
                ...
                <td>{setHpPnFormat(mbInfo.mbHpPnEnc)}</td>
              </tr>
              <tr>
                <th>
