...
const MypageManageList7 = () => {
  ...
  const dispatch = useDispatch();
    ...
    const handleFilter = useCallback(filter => e => {
      e.preventDefault();
      setViewFilter(filter === "sales_hold" ? 1 : 2);
    }, [viewFilter]);
                  ...
                  <ul>
                    <li>
                      ...
                      <ul className="car-date-wrap">
                        ...
                        <li className="tx-red80">광고기간 종료</li>
                      </ul>
                    </li>
                    <li>
                      <span>
                      ...
                      <ul className="car-date-wrap">
                        <li>등록일 : 2019.00.00</li>
                        <li>판매일 : 2019.00.00</li>
                        <li className="tx-red80">허위매물로 신고</li>
                      </ul>
                    </li>
                  </ul>
                </div>
                ...
                <li className="btn-wrap">
                  ...
                  <Buttons align="center" marginBottom={8}>
                    <Button
                      ...
                      height={38}
                      measure={'%'}
                      onClick={handleFilter("sales_hold")}
                    />
                    <Button
                      size="mid"
  ...
  return (
    <div className="register-admin-sec standby-car-sec">
      ...
      <ul className="float-wrap">
        <li><p className="inquire-num">보류차량 : 총 15대</p></li>
        <li>
          ...
          <div className="admin-list tp2">
            <div className="content-top">
              ...
              <ul className="numerical">
                ...
                <li><i className="ico-dot sml"></i>보류일<span>2019-09-23</span></li>
                <li><i className="ico-dot sml"></i>보류사유<span>허위매물로 신고</span></li>
              </ul>
            </div>
          </div>
        </li>
          ...
          <div className="admin-list tp2">
            <div className="content-top">
              ...
              <ul className="numerical">
                <li><i className="ico-dot sml"></i>등록일<span>209-08-08</span></li>
                <li><i className="ico-dot sml"></i>보류일<span>2019-09-23</span></li>
                <li><i className="ico-dot sml"></i>보류사유<span>광고기간 종료</span></li>
              </ul>
            </div>
          </div>
        </li>
...
export default MypageManageList7;