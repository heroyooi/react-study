...
const MypageManageList1 = () => {
  ...
  if (hasMobile) {
    ...
    const handleChange1_1 = useCallback((e) => {
      e.preventDefault();
      setIsValue1_1(Number(e.target.value));
    ...
    const handleChange1_2 = useCallback((e) => {
      e.preventDefault();
            ...
            <li>
              <div className="float-wrap btn-xs mb20">
                ...
                <div className={btnsClass} ref={btnsEl}>
                  ...
                  <Button size="sml" line="gray" color="gray" radius={true} title="대기차량 이동" width={74} height={24} fontSize={10} fontWeight={500} marginLeft={8} onClick={(e) => openMovePop(e, "fade")}/>
                  <Button size="sml" line="gray" color="gray" radius={true} title="업데이트 자유권 관리" width={92} height={24} fontSize={10} fontWeight={500} marginLeft={8} onClick={handleFullpagePopup("ticket")}/>
                </div>
              </div>
              {withoutList ? (
          ...
          <MobBottomArea active={active2} zid={101}>
            <div className="inner">
              ...
              <ul className="radio-group vertical border">
                <li>
                  <Radio id="coupon1" label="실차주 요청으로 인한 삭제" value={1} checked={isValue1_1} onChange={handleChange1_1} />
                </li>
                <li>
                  <Radio id="coupon2" label="차량 소속 변경" value={2} checked={isValue1_1} onChange={handleChange1_1} />
                </li>
                <li>
                  <Radio id="coupon3" label="기타" value={3} checked={isValue1_1} onChange={handleChange1_1} />
                </li>
              </ul>
                ...
                <div className="sell-declare">
                  <span className="bridge2">
                    ...
                    <ul className="radio-block small">
                      <li><Radio className="txt" id="autobell" label="오토벨" value={1} checked={isValue1_2} onChange={handleChange1_2} /></li>
                      <li><Radio className="txt" id="othersite" label="타사이트" value={2} checked={isValue1_2} onChange={handleChange1_2} /></li>
                      <li><Radio className="txt" id="offline" label="오프라인" value={3} checked={isValue1_2} onChange={handleChange1_2} /></li>
                    </ul>
                  </span>
                  <span className="bridge2">
        ...
        withoutList === false && (
          <div className="register-state-modify">
            ...
            <div className="btn-wrap">              
              ...
              <Button size="mid" line="gray" color="black" radius={true} title="등록대기차량으로 이동" width={160} marginLeft={8} onClick={(e) => rodalPopupHandler3(e, "slideUp")} />
