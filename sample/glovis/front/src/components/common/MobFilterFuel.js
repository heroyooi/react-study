...
const MobFilterFuel = ({ displayMemberPath, itemsSource, internalSelectedItems, selectedValuePath, onChange, onSelect }) => {
  return (
    <>
...
export default withMobFilterPopUp(MobFilterFuel);
