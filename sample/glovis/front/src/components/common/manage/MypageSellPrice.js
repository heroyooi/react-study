...
const MypageSellPrice = ({ mode = 'tooltip', onChangePrice, price = '' }) => {
      ...
      <div className="register-sell-price">
        ...
        <div className="sell-price-wrap">
          <div className={mode === 'tooltip' ? 'sell-price' : 'sell-price viewer'}>
            <Input type="text" id="register-sell-price" value={price} width={176} height={40} onChange={onChangePrice} name="price" />
            <em>만원</em>
            {mode === 'tooltip' ? (
