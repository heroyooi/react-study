...
import MypageFilterSelect from '@src/components/common/manage/MypageFilterSelect';
...
const MypageManageList1 = ({ onClick }) => {
  ...
  const selectItem = (e, v) => {
    onClick(e, v);
    rodalPopupHandler8(e, 'slideUp');
  };

  const selectItem2 = (e, v) => {
    onClick(e, v);
    rodalPopupHandler9(e, 'slideUp');
  };
        ...
        {withoutList === false ? (
          <li>
            {managementCarList.map((v, index) => {
              return (
                <div className="admin-list tp1" key={index}>
                  <div className="content-top">
                    ...
                    <ul className="numerical">
                      <li>
                        <i className="ico-dot sml"></i>판매기간<span>53일</span>
                      </li>
                      <li>
                        <i className="ico-dot sml"></i>조회수(일평균)<span>20회</span>
                      </li>
                      <li>
                        <i className="ico-dot sml"></i>관심고객(최근2주)<span>13명</span>
                      </li>
                      <li>
                        <i className="ico-dot sml"></i>동급매물(최근4주)
                        <span>
                          <i className="ico-triangle-top"></i>4주
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="btn-wrap">
                    ...
                    <div className="btn-right">
                      <Button size="sml" line="gray" radius={true} title="가격 수정" width={101} onClick={(e) => selectItem(e, v)} />
                      <Button size="sml" line="gray" radius={true} title="차량정보 수정" width={101} onClick={(e) => selectItem2(e, v)} />
