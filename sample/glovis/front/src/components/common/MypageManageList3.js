...
const MypageManageList3 = () => {
  ...
  if (hasMobile) {
    ...
    // 버튼식 라디오
    const [isValue3_1, setIsValue3_1] = useState(0);
    const [isValue3_2, setIsValue3_2] = useState(0);
    const handleChange3_1 = useCallback((e) => {
      e.preventDefault();
      setIsValue3_1(Number(e.target.value));
    }, [isValue3_1]);
    const handleChange3_2 = useCallback((e) => {
      e.preventDefault();
      setIsValue3_2(Number(e.target.value));
    }, [isValue3_2]);
      ...
      <>
        <div className="register-admin-sec">
          <div className="float-wrap btn-s">
            <h3 className="tit2">판단보류차량 목록</h3>
        ...
        <MobBottomArea active={active2} zid={101}>
          <div className="inner">
            ...
            <ul className="radio-group vertical border">
              <li>
                <Radio id="coupon1" label="실차주 요청으로 인한 삭제" value={1} checked={isValue3_1} onChange={handleChange3_1} />
              </li>
              <li>
                <Radio id="coupon2" label="차량 소속 변경" value={2} checked={isValue3_1} onChange={handleChange3_1} />
              </li>
              <li>
                <Radio id="coupon3" label="기타" value={3} checked={isValue3_1} onChange={handleChange3_1} />
              </li>
            </ul>
              ...
              <div className="sell-declare">
                <span className="bridge2">
                  ...
                  <ul className="radio-block small">
                    <li><Radio className="txt" id="autobell" label="오토벨" value={1} checked={isValue3_2} onChange={handleChange3_2} /></li>
                    <li><Radio className="txt" id="othersite" label="타사이트" value={2} checked={isValue3_2} onChange={handleChange3_2} /></li>
                    <li><Radio className="txt" id="offline" label="오프라인" value={3} checked={isValue3_2} onChange={handleChange3_2} /></li>
                  </ul>
                </span>
                <span className="bridge2">
        ...
        <li>
          <div className="admin-list tp1">
            ...
            <div className="content-bottom">
              <p className="state hold">판단보류<span>(만료 00일 전)</span></p>
              <ul> 
...
export default MypageManageList3;