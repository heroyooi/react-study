...
export const api_list = {
  ...
  checkbox: [
    ...
    },
    {
      property: 'agreeType',
      description:
        'CheckBoxGroup 컴포넌트에서 사용<br />일반 Checkbox 컴포넌트일 경우 false,<br />모두 동의 체크박스에 사용되는 Checkbox 컴포넌트일 경우 true<br /><br />예시 페이지: /homeService/serviceStep03_01',
      type: 'boolean',
      default: 'false'
    },
    {
