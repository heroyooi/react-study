...
export const types = {
  GET_CARS_STUDIO: 'buycar/livestudio/buyCarList/GET_CARS_STUDIO',
  TOGGLE_INTEREST: 'buycar/livestudio/buyCarList/TOGGLE_INTEREST'
};

export const getCarListStudio = (itemMaxPerPage) => async (dispatch) => {
