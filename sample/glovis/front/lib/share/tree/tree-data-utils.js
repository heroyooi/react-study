...
export function changeNodeAtPath({ treeData, path, newNode, getNodeKey, ignoreCollapsed = true }) {
  ...
  const traverse = ({ isPseudoRoot = false, node, currentTreeIndex, pathIndex }) => {
    ////console.log('traverse>node=%o,currentTreeIndex=%o, pathIndex=%o', node, currentTreeIndex, pathIndex);
    // debugger;
    if (!isPseudoRoot && getNodeKey({ node, treeIndex: currentTreeIndex }) !== path[pathIndex]) {
      return RESULT_MISS;
    }
    ////console.log('changeNodeAtPath>path=%o', path);
...
export function removeNodeAtPath({ treeData, path, getNodeKey, ignoreCollapsed = true }) {
  //console.log('removeNodeAtPath path=%o, ', path);
...
export function addNodeUnderParent({ treeData, newNode, parentKey = null, getNodeKey, ignoreCollapsed = true, expandParent = false, addAsFirstChild = false }) {
  ...
  console.log('addNodeUnderParent parentKey=%s,treeData=%o,getNodeKey=%o', parentKey, treeData, getNodeKey);
  ...
  const changedTreeData = map({
    ...
    callback: ({ node, treeIndex, path }) => {
      ...
      console.log('addNodeUnderParent [[parentNode]]=%o,[[children]]=%o [[rtnObject]]=%o', parentNode, children, rtnObject);
      return rtnObject;
    }
  });
