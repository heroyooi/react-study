...
const ContractorInfo_1 = ({ query }) => {
  ...
  const { inputInfo, bankCdList, policyList, hpPnCdList, mbInfo } = useSelector((state) => state.home);
  ...
  const [isAddr2Check, setIsAddr2Check] = useState(false); //공동명의자 사업장 주소
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    ...
                    <span className="bridge2">
                      <MobSelectBox id="hpPn1_1" options={hpPrefixOpt ? hpPrefixOpt : []} width="20%" onClick={(e) => onClickSelectHp(e, 'hpPn1_1')} />
                      <Input
                        id="hpPn1_2"
                        type="text"
                    ...
                    <span className="bridge2">
                      ...
                      />
                      <Button size="mid" background={verification1 ? 'blue80' : 'gray60'} radius={true} title="인증확인" onClick={(e) => onClickBtn(e, 'hpNoEnc1Chk')} measure={true} width={24.5} />
                    </span>
                ...
                <tr>
                  <td>
                    ...
                    <span className="bridge2">
                      <MobSelectBox id="bankDvcd" uuid={true} options={bankCdOpt ? bankCdOpt : []} onClick={(e) => onClickSelectBank(e, 'bankDvcd')} width="30%" />
                      <Input
                        id="acntNoEnc"
                        type="text"
                      ...
                      <>
                        ...
                        <tr>
                          <td>
                            <p className="tx-tit">
                              사업장주소
                              <CheckBox className="fr" id="chk-address2" title="개인주소와 동일" onChange={(e) => onChangeCheck(e)} />
                            </p>
                            <span className="bridge2">
                              <Input
                                id="plbzAddrZcd2"
                            ...
                            {!formData.plbzAddrSec2 && isAddr2Check && <p className="tx-sub tx-red80">상세주소를 입력해주세요.</p>}
                          </td>
                        </tr>
                      </>
                    )}
                ...
                <tr>
                  <td>
                    차량양도계약서 서명방식
                    <RadioGroup dataList={[{ id: 'm-radio-1', key: 1, value: 1, checked: false, disabled: false, label: '직접서명' }]} className="fr" />
                  </td>
                </tr>
              </tbody>
            </table>
...
ContractorInfo_1.getInitialProps = async (http) => {
...
export default withRouter(ContractorInfo_1);
