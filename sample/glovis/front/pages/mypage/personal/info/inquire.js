/**
 * 설명 : 나의 문의내역
 * @fileoverview 마이페이지>회원정보 관리>나의 문의내역
...
*/
  ...
  if (hasMobile) {
    //기간별 조회
    const handleBtnFilterClick1 = (e, label) => {
      calendarCallback1(e, moment().subtract(label.id, 'month'));
      calendarCallback2(e, moment());
    };
            ...
            <ul className="m-toggle-list search mt16">
              <MenuItem>
                ...
                <MenuCont>
                  <MobButtonFilter
                    checkList={[
                      { title: '1개월', checked: true, id: '1' },
                      { title: '3개월', checked: false, id: '3' },
                      { title: '6개월', checked: false, id: '6' },
                      { title: '1년', checked: false, id: '12' }
                    ]}
                      ...
                      inquireList.map((lists, index) => {
                        return (
                          <tr key={index}>
                            ...
                            <td className="tx-l" onClick={(e) => onClickHandler(e, '/mypage/personal/info/inquireView', lists.seqNo)}>
                              {lists.quesTtlNm}
                            </td>
