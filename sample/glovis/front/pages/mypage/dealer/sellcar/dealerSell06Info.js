    ...
    <AppLayout>
      <div className="mypage-state-sec dealer-live-sec">
        ...
        <div className="content-wrap live-sec">
          ...
          <Link href="/mypage/dealer/sellcar/photographAppointmentIndex"><a>자세히보기</a></Link>
            ...
            <li>
              ...
              <div className="summary">
                <div className="float-wrap btn-xs">
                  ...
                  <Button size="sml" background="blue80" radius={true} title="예약신청" width={76} height={24} fontSize={10} fontWeight={500} href="/mypage/dealer/sellcar/dealerSell06Studio01" nextLink={true} />
                </div>
            ...
            <li>
              ...
              <div className="summary">
                <div className="float-wrap btn-xs">
                  ...
                  <Button size="sml" background="blue80" radius={true} title="예약신청" width={76} height={24} fontSize={10} fontWeight={500} href="/mypage/dealer/sellcar/dealerSell06Shot01" nextLink={true} />
                </div>
        ...
        <div className="content-sec">
          ...
          <Buttons align="center" marginTop={8}>
            <Button size="sml" line="gray" radius={true} title="예약현황" width={53} height={24} fontSize={10} href="/mypage/dealer/sellcar/photographAppointment" nextLink={true} />
          </Buttons>
        </div>
      </div>
    </AppLayout>
