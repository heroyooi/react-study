        ...
        <div className="mypage-state-sec general-inquire-sec">
          ...
          <div className="list-wrap">
            ...
            <div className="view-wrap">
              ...
              <Button size="mid" background="gray" title="목록으로" width={160} height={48} href="dealerInquire" />
            </div>
          </div>
        </div>
      </div>
...
DealerInquireView.getInitialProps = async (http) => {
  // eslint-disable-next-line no-unused-vars
...
export default DealerInquireView;
