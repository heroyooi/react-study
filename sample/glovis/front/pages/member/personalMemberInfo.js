...
const PersonalMemberInfo = () => {
  ...
  const { mbId, mbPwdEnc, mbPwdEncChk, mbEmlAddr, mbEmlAddrDomain, mbZcd, mbAddrEnc, mbDtlAddrEnc } = inputs;
          ...
          <div className="content-wrap member-contents">
            <form className="join-form">
              <fieldset>
                ...
                {/* 오토옥션 연동 기본 */}
                <JoinDealerInfo mbInfo={mbInfo} mbTpcd={mbTpcd} onChange={onChange} onBlur={onBlur} />
              </fieldset>
            </form>
...
export default PersonalMemberInfo;
