    ...
    <div className="coding-wrap">
      ...
      <ul className="coding-map">
          ...
          <>
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-BC-AC-001</span>
                </li>
                <li className="file">
                  <span>buy/list?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/list?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>buy/listSearch</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/listSearch">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>buy/liveList</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/liveList">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>buy/liveGuide</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/liveGuide">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>buy/auctionList</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/auctionList">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>buy/certifyMall</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/certifyMall">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-BC-CM-003</span>
                </li>
                <li className="file">
                  <span>buy/certifyMallInquire</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/certifyMallInquire">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>buy/brandList</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/brandList">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>buy/brandSearch</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/brandSearch">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>금융사/프랜차이즈 인증 차량조건 검색</span>
                </li>
                <li>
                  <span></span>
                </li>
                ...
                <li className="file">
                  <span>buy/financeSearch</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/financeSearch">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>buy/viewDetailDiagnosis</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/viewDetailDiagnosis">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-BC-DT-001</span>
                </li>
                <li className="file">
                  <span>buy/viewImgList</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/buy/viewImgList">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-BC-DT-005</span>
                </li>
                <li className="file">
                  <span>buy/viewInquire</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/viewInquire">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-BC-DT-004</span>
                </li>
                <li className="file">
                  <span>buy/totalCostCalculation</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/totalCostCalculation">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-BC-DT-003</span>
                </li>
                <li className="file">
                  <span>buy/falseSaleReport</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/falseSaleReport">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-BC-DT-010</span>
                </li>
                <li className="file">
                  <span>buy/viewAccidentHistory</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/viewAccidentHistory">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>성능점검기록부 팝업</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-BC-DT-011</span>
                </li>
                <li className="file">
                  <span>buy/viewPerformance</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/buy/viewPerformance">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-BC-DT-007</span>
                </li>
                <li className="file">
                  <span>buy/sellerInfo</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/sellerInfo">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-BC-AC-002</span>
                </li>
                <li className="file">
                  <span>buy/quickMenu</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/quickMenu">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>buy/quickMenu?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/buy/quickMenu?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
          ...
          <>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-SC-SS-009</span>
                </li>
                <li className="file">
                  <span>sell/selfStep03</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/sell/selfStep03">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>차량사진등록(모바일 앱_촬영 기능 호출 전)</span>
                </li>
                <li>
                  <span></span>
                </li>
                ...
                <li className="file">
                  <span>sell/selfStep03?ver=2</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/sell/selfStep03?ver=2">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>차량사진등록(모바일 앱_촬영 기능 호출 후)</span>
                </li>
                <li>
                  <span></span>
                </li>
                ...
                <li className="file">
                  <span>sell/selfStep03?ver=3</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/sell/selfStep03?ver=3">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-SC-SS-010</span>
                </li>
                <li className="file">
                  <span>sell/selfStep03_01</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/sell/selfStep03_01">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-SC-SS-011~4</span>
                </li>
                <li className="file">
                  <span>sell/selfStep03_02</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/sell/selfStep03_02">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>sell/freeStep01Filter01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/sell/freeStep01Filter01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
        ...
        <li>
          <ul className="row main-sec">
            <li className="nbd">
              <span className="toggle-btn" onClick={handleToggle3}>
                {toggle3 ? '-' : '+'}
              </span>
              <span>시세조회</span>
            </li>
            ...
            <li>
              <span>IA-M-SP-MA-001</span>
            </li>
            <li className="file">
              <span>marketPrice/marketPrice</span>
            </li>
            <li className="progress">{createProgress(100)}</li>
            <li className="link">
          ...
          <>
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-SP-CS-007</span>
                </li>
                <li className="file">
                  <span>marketPrice/marketSearch</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/marketPrice/marketSearch">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-SP-CS-004</span>
                </li>
                <li className="file">
                  <span>marketPrice/marketView?search=condition</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/marketPrice/marketView?search=condition">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-SP-CS-008</span>
                </li>
                <li className="file">
                  <span>marketPrice/marketView?search=number</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/marketPrice/marketView?search=number">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>결과O(등급 미포함)</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-SP-NS-001</span>
                </li>
                <li className="file">
                  <span>marketPrice/marketViewGrade</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/marketPrice/marketViewGrade">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>marketPrice/marketView?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/marketPrice/marketView?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
        ...
        <li>
          <ul className="row main-sec">
            ...
            <li className="file">
              <span>homeService/serviceInfo</span>
            </li>
            <li className="progress">{createProgress(100)}</li>
            <li className="link">
              <Link href="/homeService/serviceInfo">
                <a className="link-btn" target="_blank">
                  완료
                </a>
              </Link>
          ...
          <>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>homeService/homeService?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/homeService/homeService?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>homeService/serviceStep01</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/homeService/serviceStep01">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>homeService/serviceStep02</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/homeService/serviceStep02">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>homeService/serviceStep03</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/homeService/serviceStep03">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>homeService/serviceStep03_01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/homeService/serviceStep03_01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>homeService/serviceStep03_02</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/homeService/serviceStep03_02">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>homeService/serviceStep03_03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/homeService/serviceStep03_03">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>homeService/serviceStep04</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/homeService/serviceStep04">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>homeService/serviceStep05</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/homeService/serviceStep05">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
          ...
          <>
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>autoAuction/auctionHome</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/autoAuction/auctionHome">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-AA-GS-006</span>
                </li>
                <li className="file">
                  <span>autoAuction/auctionInfoSample</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/autoAuction/auctionInfoSample">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>autoAuction/exhibitStep01</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/autoAuction/exhibitStep01">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>스마트옥션 경매약관 및 주의사항</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-AA-EA-010</span>
                </li>
                <li className="file">
                  <span>autoAuction/termsView?seq=0</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/termsView?seq=0">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>세금계산서 발행의무</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-AA-EA-011</span>
                </li>
                <li className="file">
                  <span>autoAuction/termsView?seq=1</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/termsView?seq=1">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-AA-EA-012</span>
                </li>
                <li className="file">
                  <span>autoAuction/termsView?seq=2</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/termsView?seq=2">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>자동차매매(경매)행위에 대한 위/수임 확인</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-AA-EA-013</span>
                </li>
                <li className="file">
                  <span>autoAuction/termsView?seq=3</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/termsView?seq=3">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>현금영수증 발행 동의 확인</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-AA-EA-014</span>
                </li>
                <li className="file">
                  <span>autoAuction/termsView?seq=4</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/termsView?seq=4">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>autoAuction/exhibitStep01_02</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/exhibitStep01_02">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>경매장 위치 안내 팝업</span>
                </li>
                <li>
                  <span>IA-M-AA-EA-006</span>
                </li>
                <li className="file">
                  <span>autoAuction/viewMap</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/viewMap">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>autoAuction/exhibitStep02</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/exhibitStep02">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-AA-EA-007</span>
                </li>
                <li className="file">
                  <span>autoAuction/accountNum</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/accountNum">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>autoAuction/exhibitStep03?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/exhibitStep03?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>autoAuction/exhibitStep03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/exhibitStep03">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>예상 낙찰가 조회-결과X</span>
                </li>
                <li>
                  <span>IA-M-AA-EA-008</span>
                </li>
                <li className="file">
                  <span>autoAuction/searchBid?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/searchBid?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>예상 낙찰가 조회-결과o</span>
                </li>
                <li>
                  <span>IA-M-AA-EA-008</span>
                </li>
                <li className="file">
                  <span>autoAuction/searchBid</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/searchBid">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-AA-EA-009</span>
                </li>
                <li className="file">
                  <span>autoAuction/consignInfo</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/consignInfo">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>autoAuction/exhibitStep04</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/exhibitStep04">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>autoAuction/exhibitStep05</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/autoAuction/exhibitStep05">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
        ...
        <li>
          <ul className="row main-sec">
            <li>
              <span className="toggle-btn" onClick={handleToggle6}>
                {toggle6 ? '-' : '+'}
              </span>
              <span>프라이싱시스템</span>
            </li>
            ...
            <li>
              <span>IA-M-PS-AD-001</span>
            </li>
            <li className="file">
              <span>pricingsystem/pricing</span>
            </li>
            <li className="progress">{createProgress(100)}</li>
            <li className="link">
          ...
          <>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-PS-MA-001</span>
                </li>
                <li className="file">
                  <span>pricingsystem/pricingSearch</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/pricingsystem/pricingSearch">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>pricingsystem/pricingView</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/pricingsystem/pricingView">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>pricingsystem/pricingSearchNum</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/pricingsystem/pricingSearchNum">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>pricingsystem/pricingViewNum</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/pricingsystem/pricingViewNum">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>pricingsystem/pricingViewGrade</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/pricingsystem/pricingViewGrade">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-PS-MA-009</span>
                </li>
                <li className="file">
                  <span>pricingsystem/pricingInfo</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/pricingsystem/pricingInfo">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-PS-MA-012</span>
                </li>
                <li className="file">
                  <span>pricingsystem/pricingSpecify</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/pricingSystem/pricingSpecify">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>동급차량 실제 낙찰정보</span>
                </li>
                <li>
                  <span>IA-M-PS-MA-007</span>
                </li>
                <li className="file">
                  <span>pricingsystem/PricingBidInfo</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/pricingsystem/PricingBidInfo">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>경매낙찰 차량 상세보기</span>
                </li>
                <li>
                  <span>IA-M-PS-MA-002</span>
                </li>
                <li className="file">
                  <span>pricingsystem/PricingAuctionInfo</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/pricingsystem/PricingAuctionInfo">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-PS-MA-003</span>
                </li>
                <li className="file">
                  <span>pricingsystem/pricingPerformance</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/pricingsystem/pricingPerformance">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-PS-MA-004</span>
                </li>
                <li className="file">
                  <span>pricingsystem/pricingAccidentHistory</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/pricingsystem/pricingAccidentHistory">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>pricingSystem/pricingView?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/pricingSystem/pricingView?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
        ...
        <li>
          <ul className="row main-sec">
            ...
            <li className="file">
              <span>mypage/generalMain</span>
            </li>
            <li className="progress">{createProgress(100)}</li>
            <li className="link">
              <Link href="/mypage/generalMain">
                <a className="link-btn" target="_blank">
                  완료
                </a>
              </Link>
          ...
          <>
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalMain?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalMain?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MU-BC-002</span>
                </li>
                <li className="file">
                  <span>mypage/generalBuy01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalBuy01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalBuy01?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalBuy01?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalBuy03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalBuy03">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalBuy03?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalBuy03?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalBuy04</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalBuy04">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalBuy04?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalBuy04?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalSell01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalSell01?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell01?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalSell_v01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_v01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>24시간 실시간 비교견적 입찰현황</span>
                </li>
                <li>
                  <span>IA-M-MU-SC-004</span>
                </li>
                <li className="file">
                  <span>mypage/generalSell_s03Bid</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_s03Bid">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>24시간 실시간 비교견적 입찰 현황(딜러O)</span>
                </li>
                <li>
                  <span>IA-M-MU-SC-005</span>
                </li>
                <li className="file">
                  <span>mypage/generalSell_s04Bid</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_s04Bid">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>24시간 실시간 비교견적 입찰 현황(딜러X)</span>
                </li>
                <li>
                  <span>IA-M-MU-SC-005</span>
                </li>
                <li className="file">
                  <span>mypage/generalSell_s04Bid?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_s04Bid?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MU-SC-008</span>
                </li>
                <li className="file">
                  <span>mypage/generalSell_s04Intro</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_s04Intro">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalSell_s04Intro?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_s04Intro?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MU-SC-009</span>
                </li>
                <li className="file">
                  <span>mypage/generalSell_s04Review</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_s04Review">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalSell_s05Review</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_s05Review">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalSell_n01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_n01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalSell_n03Check</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_n03Check">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalSell_n04Check</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_n04Check">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MU-SC-014</span>
                </li>
                <li className="file">
                  <span>mypage/generalSell_n05Check</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_n05Check">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalSell_n06Check</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell_n06Check">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalSell02</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalSell02">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/dealerMember01_01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01_01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>STEP2. 회원정보 수정</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-US-UM-002</span>
                </li>
                <li className="file">
                  <span>mypage/generalMember01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalMember01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/dealerMember01_03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01_03">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/dealerMember01_04</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01_04">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/generalMember03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalMember03">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>나의 문의내역 상세</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-US-UM-008</span>
                </li>
                <li className="file">
                  <span>mypage/generalMember03_01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/generalMember03_01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/dealerMember01_05</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01_05">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/dealerMember01_06</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01_06">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
        ...
        <li>
          <ul className="row main-sec">
            ...
            <li>
              <span>IA-M-MN-SC-001</span>
            </li>
            <li className="file">
              <span>mypage/guestMain</span>
            </li>
            <li className="progress">{createProgress(0)}</li>
            <li className="link">
              <Link href="/mypage/guestMain">
                <a className="link-btn before" target="_blank">
                  작업전
                </a>
              </Link>
        ...
        <li>
          <ul className="row main-sec">
            <li>
              <span>
                <span className="toggle-btn" onClick={handleToggle8}>
                  {toggle8 ? '-' : '+'}
                </span>
                마이페이지(딜러)
              </span>
            ...
            <li>
              <span>IA-M-MD-MA-001</span>
            </li>
            <li className="file">
              <span>mypage/dealerMain</span>
            </li>
            <li className="progress">{createProgress(100)}</li>
            <li className="link">
              <Link href="/mypage/dealerMain">
                <a className="link-btn" target="_blank">
                  완료
                </a>
              </Link>
          ...
          <>
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/dealerMain?member=stop</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMain?member=stop">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>단체회원ID를 발급받지 않은 개인딜러</span>
                </li>
                <li>
                  <span></span>
                </li>
                ...
                <li className="file">
                  <span>mypage/dealerMain?member=no-group-id</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMain?member=no-group-id">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-MA-003</span>
                </li>
                <li className="file">
                  <span>mypage/dealerNote</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerNote">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/dealerNote?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerNote?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-MA-005</span>
                </li>
                <li className="file">
                  <span>mypage/dealerPoint?page=point</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerPoint?page=point">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-MA-006</span>
                </li>
                <li className="file">
                  <span>mypage/dealerPoint?page=coupon</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerPoint?page=point">
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-001</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell01</span>
                </li>
                <li className="progress">{createProgress(50)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell01">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
                  ...
                  <div className="btn-tooltip">
                    <Tooltip placement="bottom" width={250} event="click">
                      ...
                      <TooltipCont half={true}>
                        <div className="work-exp">
                          <p>( 등록차량 관리 )</p>
                          <p>- 판매중 > 상세조회 클릭 > 상세버튼 라디오 기능 필요</p>
                          <p>- 판매중 > 상세조회 클릭 > 상세버튼 판매완료신고일순 및 3개월 값 디폴트 필요</p>
                          <p>( 광고관리 )</p>
                          <p>- 광과이용권안내 > 구입하기 클릭 > 기획 수급 필요</p>
                        </div>
                      </TooltipCont>
                    </Tooltip>
                  </div>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-103</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell01Payment</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell01Payment">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
                ...
                <li>
                  <div className="btn-tooltip">
                    <Tooltip placement="bottom" width={250} event="click">
                      ...
                      <TooltipCont half={true}>
                        <div className="work-exp">
                          <p>- 결제수단 경우에 따른 주석 전환 필요</p>
                          <p>- 증빙자료 > 버튼 라디오 기능 필요</p>
                        </div>
                      </TooltipCont>
                    </Tooltip>
                  </div>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-111</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell01Effect</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell01Effect">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/dealerSell01Effect?result=no</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell01Effect?result=no">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>차량 기본정보 확인</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-MD-SC-201</span>
                </li>
                <li className="file">
                  <span>mypage/</span>
                </li>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>STEP1. 차량정보 입력</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-MD-SC-202</span>
                </li>
                <li className="file">
                  <span>mypage/</span>
                </li>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>STEP2. 가격 및 차량소개</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-MD-SC-203</span>
                </li>
                <li className="file">
                  <span>mypage/</span>
                </li>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>STEP3. 차량 설명글 입력</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-MD-SC-204</span>
                </li>
                <li className="file">
                  <span>mypage/</span>
                </li>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>STEP4. 성능점검</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-MD-SC-205</span>
                </li>
                <li className="file">
                  <span>mypage/</span>
                </li>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>사고·교환·수리 등 이력</span>
                </li>
                <li>
                  <span>IA-M-MD-SC-206</span>
                </li>
                <li className="file">
                  <span>mypage/</span>
                </li>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>STEP5. 차량사진등록</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-MD-SC-208</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell02_06</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell02_06">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>STEP7. 등록완료</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-MD-SC-210</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell02_09</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell02_09">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-300</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell03</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell03">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-301</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell03_01</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell03_01">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-302</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell03_02</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell03_02">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-400</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell04</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell04">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-500</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell05</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell05">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/dealerSell05?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell05?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-501</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell05_01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell05_01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-502</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell05_02</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell05_02">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-503</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell05_03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell05_03">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-504</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell05_04</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell05_04">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-505</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell05_05</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell05_05">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-600</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell06Info</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell06Info">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-613</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell06</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell06">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>Live 서비스 안내</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-MD-SC-601</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell06_01</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell06_01">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>Live Studio 촬영 예약</span>
                </li>
                <li>
                  <span>지점/예약시간 선택</span>
                </li>
                <li>
                  <span>IA-M-MD-SC-603</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell06Studio01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell06Studio01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-605</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell06Studio02</span>
                </li>
                <li className="progress">{createProgress(80)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell06Studio02">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-607</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell06Studio03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell06Studio03">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>Live Shot 촬영 예약</span>
                </li>
                <li>
                  <span>차량정보 입력(내역O)</span>
                </li>
                <li>
                  <span>IA-M-MD-SC-608</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell06Shot01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell06Shot01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>차량정보 입력(내역X)</span>
                </li>
                <li>
                  <span>IA-M-MD-SC-608</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell06Shot01?result=no</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell06Shot01?result=no">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-609</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell06Shot02</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell06Shot02">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-611</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell06Shot03</span>
                </li>
                <li className="progress">{createProgress(80)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell06Shot03">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-612</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell06Shot04</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell06Shot04">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-SC-700</span>
                </li>
                <li className="file">
                  <span>mypage/dealerSell07</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/mypage/dealerSell07">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-BC-001</span>
                </li>
                <li className="file">
                  <span>mypage/dealerBuy01</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerBuy01">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-BC-002</span>
                </li>
                <li className="file">
                  <span>mypage/dealerBuy01_01?auction=true</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerBuy01_01?auction=true">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>mypage/dealerBuy01?seq=2</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/mypage/dealerBuy01?seq=2">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>방문일자 입력/수정</span>
                </li>
                <li>
                  <span>IA-M-MD-BC-101</span>
                </li>
                <li className="file">
                  <span>mypage/</span>
                </li>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>거래지연 사유 입력/확인</span>
                </li>
                <li>
                  <span>IA-M-MD-BC-102</span>
                </li>
                <li className="file">
                  <span>mypage/</span>
                </li>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>거리불발 사유 입력/확인</span>
                </li>
                <li>
                  <span>IA-M-MD-BC-103</span>
                </li>
                <li className="file">
                  <span>mypage/</span>
                </li>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>거래 성사 완료 신고</span>
                </li>
                <li>
                  <span>IA-M-MD-BC-105</span>
                </li>
                <li className="file">
                  <span>mypage/</span>
                </li>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-AA-001</span>
                </li>
                <li className="file">
                  <span>mypage/dealerAuction01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="mypage/dealerAuction01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-AA-100</span>
                </li>
                <li className="file">
                  <span>mypage/dealerAuction12</span>
                </li>
                <li className="progress">{createProgress(90)}</li>
                <li className="link">
                  <Link href="/mypage/dealerAuction12">
                    <a className="link-btn on" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-AA-102</span>
                </li>
                <li className="file">
                  <span>mypage/dealerAuction14</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerAuction14">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-AA-103</span>
                </li>
                <li className="file">
                  <span>mypage/dealerAuction15</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="mypage/dealerAuction15">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-UM-001</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-UM-002</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember01?seq=2</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01?seq=2">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>주요정보/소개글 수정</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-MD-UM-003</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember01?popup=true</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01?popup=true">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-UM-004</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember01?member=organization</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01?member=organization">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-UM-005</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember01?fs_popup=1</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01?fs_popup=1">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-UM-006</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember01?fs_popup=2</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01?fs_popup=2">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>회원정보/소개 관리</span>
                </li>
                <li>
                  <span>회원정보 수정_매매회원(개인,단체)</span>
                </li>
                <li>
                  <span>본인확인</span>
                </li>
                ...
                <li>
                  <span>IA-M-MD-UM-100</span>
                </li>
                <li className="file">
                  <span>mmypage/dealerMember01_01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01_01">
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-UM-101</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember01_02</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01_02">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-UM-103</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember01_02?member=organization</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember01_02?member=organization">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-UM-400</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember02</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember02">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-UM-401</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember02_01</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember02_01">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-UM-500</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember03">
                    <a className="link-btn before" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>광고 등록 현황_매매회원(단체)</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-MD-UM-501</span>
                </li>
                <li className="file">
                  <span>mypage/adRegistration</span>
                </li>
                <li className="progress">{createProgress(50)}</li>
                <li className="link">
                  <Link href="/mypage/adRegistration">
                    <a className="link-btn before" target="_blank">
                      작업중
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>광고 등록 현황_매매회원(개인)</span>
                </li>
                <li>
                  <span></span>
                </li>
                <li>
                  <span>IA-M-MD-UM-503</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember03_02</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember03_02">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-MD-UM-600</span>
                </li>
                <li className="file">
                  <span>mypage/dealerMember04</span>
                </li>
                <li className="progress">{createProgress(0)}</li>
                <li className="link">
                  <Link href="/mypage/dealerMember04">
                    <a className="link-btn before" target="_blank">
                      작업전
                    </a>
                  </Link>
        ...
        <li>
          <ul className="row main-sec">
            ...
            <li className="file">
              <span>dealing/dealingHome</span>
            </li>
            <li className="progress">{createProgress(90)}</li>
            <li className="link">
              <Link href="/dealing/dealingHome">
                <a className="link-btn on" target="_blank">
                  작엄중
                </a>
              </Link>
          ...
          <>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>member/loginPopup</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/member/loginPopup">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>customer/inquiryWrite</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/customer/inquiryWrite">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-CC-004</span>
                </li>
                <li className="file">
                  <span>customer/inquiryWriteComplete</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/customer/inquiryWriteComplete">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
          ...
          <>
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>member/memberStep01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="/member/memberStep01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>member/memberStep02</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/memberStep02">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>member/memberStep03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/memberStep03">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>member/memberStep04</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/memberStep04">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-US-SI-008</span>
                </li>
                <li className="file">
                  <span>member/dealerStep03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/dealerStep03">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-US-SI-012</span>
                </li>
                <li className="file">
                  <span>member/dealerStep04</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/dealerStep04">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>member/groupStep03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/groupStep03">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-US-SI-015</span>
                </li>
                <li className="file">
                  <span>member/groupStep04</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/groupStep04">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>member/allyStep03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/allyStep03">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-US-SI-018</span>
                </li>
                <li className="file">
                  <span>member/allyStep04</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/allyStep04">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-US-LI-003</span>
                </li>
                <li className="file">
                  <span>member/loginState01</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/loginState01">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>member/loginState01_02</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/loginState01_02">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>member/loginState02</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/loginState02">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>member/loginState03</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/loginState03">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li className="file">
                  <span>member/loginInfo</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/loginInfo">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
            ...
            <li>
              <ul className="row">
                ...
                <li>
                  <span>IA-M-US-LI-011</span>
                </li>
                <li className="file">
                  <span>member/loginInfoIdConfirm</span>
                </li>
                <li className="progress">{createProgress(100)}</li>
                <li className="link">
                  <Link href="member/loginInfoIdConfirm">
                    <a className="link-btn" target="_blank">
                      완료
                    </a>
                  </Link>
