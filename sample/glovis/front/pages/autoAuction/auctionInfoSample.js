      ...
      <AppLayout>
        <div className="con-wrap popup-auction">
          <div className={`tabmenu-swipe active-${tabKey}`}>
            <Tabs renderTabBar={() => <SwipeableInkTabBar pageSize={4} onTabClick={onTabClick} />} renderTabContent={() => <TabContent />} defaultActiveKey="1" onChange={tabCallback}>
              ...
              <TabPane tab="기능상태 점검항목" data-extra="tabpane" key="5">
                <div className="performace-wrap"></div>
              </TabPane>
            </Tabs>
          </div>
        </div>
