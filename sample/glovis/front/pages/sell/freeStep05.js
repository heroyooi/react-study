...
const FreeStep05 = ({ router }) => {
  ...
  const { name, mobile, location, bank } = router.query;

  if (hasMobile) {
    return (
      <AppLayout>
        <div className="co-wrap bg pb0">
          <p className="tit complete">무평가 판매 신청이<br />완료되었습니다.</p>
          <p className="exp">
            판매 신청 현황은 마이페이지에서 확인 가능하며,
            <br />
            곧 고객님의 연락처로 오토벨 상담원이 안내 드릴 예정입니다.
          </p>
...
export default withRouter(FreeStep05);
