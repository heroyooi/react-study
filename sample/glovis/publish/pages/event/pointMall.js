        ...
        <div className="event-contents point">
          ...
          <div className="pdside20 bg-white">            
            ...
            <div className="auction-process-wrap">
              <ul className="process-list">
                <li className="step1"><span className="ico"></span><span className="tit"><em>01</em>이용권 구매</span></li>
                <li className="step2"><span className="ico"></span><span className="tit"><em>02</em>포인트 적립</span></li>
                <li className="step3"><span className="ico"></span><span className="tit"><em>03</em>포인트몰 이동</span></li>
                <li className="step4"><span className="ico"></span><span className="tit"><em>04</em>제휴상품 구매</span></li>
              </ul>
            </div>           
          </div>
              ...
              <MenuItem>
                ...
                <MenuCont>
                  ...
                  <p className="tx-sub mt16">
                    * 1 POINT = 현금 1원<br />
                    * 최소 3,000P 이상부터 결제 시 사용 가능
                  </p>
                  <p className="tx-sub mt24">
                    1포인트는 오토벨 사이트 내 현금 1원을 의미하며, 사용 시 최소 3,000 포인트 이상
                    부터 결제 가능합니다. 포인트는 어떠한 경우에도 타인에게 매매 또는 양도할 수
                    없으며, 현금으로 전환할 수 없습니다. 지급 원인이 된 사건(상품 결제, 기능 사용 등)
                    이 무효화된 경우, 해당 포인트는 회수될 수 있습니다. 
                  </p>
                  <p className="tx-sub mt16">
                    ※ 유효기간<br />
          ...
          <div className="pdside20 bg-white mt10">              
            <div className="essential-point">
              <p>사용안내</p>
              <ul>
                <li><i className="ico-dot mid"></i> 제휴 된 포인트몰에서 등록된 상품 구매</li>
                <li><i className="ico-dot mid"></i> 온라인플랫폼에서 포인트 사용 불가<br />(단,포인트몰에서 온라인플랫폼 할인 쿠폰 구매 가능)</li>
              </ul>
              <p>유효기간</p>
              <ul>
                <li><i className="ico-dot mid"></i> 적립일로부터 3년간 유효하며, 미사용 포인트는 적립 후 3년 이후 자동 회수<br />(단,포인트몰에서 온라인플랫폼 할인 쿠폰 구매 가능)</li>
              </ul>
            </div>
          </div>       
        </div>        
  ...
  return (  
    <AppLayout>
      <div className="content-wrap event-contents point">
        ...
        <TabMenu type="type1" callBack={tabClick} defaultTab={2}  tabLink={[{ index: 0, url: '/event/eventList' },{ index: 1, url: '/event/eventList?eventType=end' },{ index: 2, url: '/event/pointMall' }]}>
        ...
        <p className="pointmall-chk" onClick={(e) => setSaveBasePop(e, "fade")}>오토벨 포인트몰 적립 기준을 확인해보세요</p>
        <div className="essential-point">
          <p>사용안내</p>
          <ul>
            <li><i className="ico-dot mid"></i> 제휴 된 포인트몰에서 등록된 상품 구매</li>
