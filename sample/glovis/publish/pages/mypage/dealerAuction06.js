            ...
            <TabCont tabTitle="경매회원안내" id="tab1-1" index={0}>
              ...
              <div className="auction-document-form">
                ...
                <div className="btn-set">
                  <Button radius={true} size="mid" line="gray" color="darkgray" title="위임장 다운로드" width={160} />
                  <Button radius={true} size="mid" line="gray" color="darkgray" title="회원가입서약서 다운로드" width={160} />
                </div>
              </div>
              <table summary="서류 업로드" className="table-tp1 input">
                ...
                <tbody>
                  ...
                  <tr>
                    <th>자동차관리사업등록증</th>
                    <td>
                        <Input type="text" id="da-car-management" width={470} height={40} /><Button size="big" background="blue80" title="찾아보기" width={140} height={40} />
                    </td>
                  </tr>
                  <tr>
                    <th>신청인 사진(반명함 사이즈)<em>(선택)</em></th>
                    <td>
                        <Input type="text" id="da-applicant-photo" width={470} height={40} /><Button size="big" background="blue80" title="찾아보기" width={140} height={40} />
                    </td>
                  </tr>
                  <tr>
                    <th>회원가입 서약서<em>(선택)</em></th>
                    <td>
                        <Input type="text" id="da-written-pledge" width={470} height={40} /><Button size="big" background="blue80" title="찾아보기" width={140} height={40} />
                    </td>
                  </tr>
                </tbody>
              </table>
              ...
              <Buttons align="right" marginTop={48}>
                <Button size="big" background="blue80" title="재등록" width={127} height={60} href="dealerAuction08" />
              </Buttons>
            </TabCont>
