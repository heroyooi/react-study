        ...
        <div className="mypage-state-sec guest-sec">
                ...
                <table className="table-tp1 th-c td-c" summary="결제내역에 대한 내용">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>셀프평가</td>
                      <td>
                        24시간 실시간 비교<br />견적 신청 완료
                        <Button size="mid" line="gray" color="black" radius={true} title="입찰현황 보기" width={100} height={32} marginTop={8} />
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="essential-point">
            <ul>
              ...
              <li><i className="ico-dot sml"></i> 현대오토벨 회원가입을 하시면 더 다양한 서비스를 이용하실 수 있습니다.<Button size="mid" line="gray" color="black" radius={true} title="회원가입" width={100} height={32} marginLeft={10} href="/member/memberHome" /></li>
              <li><i className="ico-dot sml"></i> 회원가입 이후 비회원 신청내역 조회를 원하시는 경우 비회원 로그인을 통해 조회하실 수 있습니다.</li>
