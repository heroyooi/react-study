...
import RadioGroup from '@lib/share/items/RadioGroup'; //#a
      ...
      <AppLayout>
        ...
        <div className="member-sec">
          <div className="content-wrap member-contents bg-white">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td colSpan="2">
                        ...
                        <p className="tx-sub tx-red80 mt8">비밀번호가 일치하지 않습니다..</p>
                      </td>
                    </tr>
                    <tr>
                      <td colSpan="2">
                        <p className="tx-tit">소속상사명</p>
            ...
            <Button className="fixed" size="full" background="blue80" title="가입완료" href="groupStep04" nextLink={true} />
          </div>
        </div>
        ...
        <div className="member-sec">
          <div className="content-wrap member-contents">
                ...
                <table summary="가입정보입력에 대한 내용" className="table-tp2">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <Input type="text" placeHolder="ID를 입력해주세요." id="user-id" width={548} />
                      </td>
                    </tr>
                    <tr>
                      <th>
                    ...
                    <tr>
                      ...
                      <td>
                        <Input type="text" value="" id="manager-no" width={548} />
                      </td>
                    </tr>
                    <tr>
                      <th>
                      ...
                      <td>
                        <Input type="text" value="" id="managerr-type" width={548} />
                      </td>
                    </tr>
                    {/* #a1 항목추가 end */}
                    <tr>
            ...
            <Buttons align="center" marginTop={60} className="w-line">
              <Button size="big" background="blue80" title="가입완료" width={180} height={60} href="groupStep04" />
            </Buttons>
          </div>
        </div>
      </div>
