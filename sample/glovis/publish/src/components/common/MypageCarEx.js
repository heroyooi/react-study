      ...
      <fieldset>
        ...
        <div className="register-car-ex">
          ...
          }
          {
            isButtonReset && (
              <div className="btn-wrap">
                <Button size="sml" line="gray" color="gray" radius={true} title="입력 내용 초기화" width={99} height={24} onClick={(e) => rodalPopupHandler3(e, "fade")} />
              </div>
            )
          }
          ...
          <div className="key-point-wrap">
            ...
            <div className="area">
              <Textarea type="tp1" countLimit={50} disabled={textareaDisabled1} placeHolder="에디터 화면 노출 영역" data={textareaData1} onChange={textareaChange1} isSelf={false} />
            </div>
          ...
          <div className="scratch-photo-wrap">
            ...
            <div className="area">
              <Textarea type="tp1" countLimit={50} disabled={textareaDisabled2} placeHolder="에디터 화면 노출 영역" data={textareaData2} onChange={textareaChange2} isSelf={false} />
            </div>
            <InputFile uploadList={uploadList1} />
          </div>
