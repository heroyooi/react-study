...
class IniStdPayResponse extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    jqueryUiScript.src = 'https://stgstdpay.inicis.com/stdjs/INIStdPay.js';
...
export default withRouter(IniStdPayResponse);
