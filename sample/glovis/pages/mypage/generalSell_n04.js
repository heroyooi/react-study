        ...
        <div className="general-sell-sec">
          ...
          <div className="table-area content-border">
            <ul className="m-toggle-list up-blue fs16">
              <MenuItem>
                <MenuTitle>진행현황<span>차량 상태 점검</span></MenuTitle>
                <MenuCont>
          ...
          {bluePop && <div className="stop-cover">
            ...
            <p>차량의 점검을 위해<br />성능점검이 진행됩니다.</p>
            <Buttons align="center" marginTop={12}>
              <Button size="sml" line="gray" radius={true} title="견적확인" width={88} height={30} href="/mypage/generalSell_n04Check" />
            </Buttons>
          </div>}
        </div>
