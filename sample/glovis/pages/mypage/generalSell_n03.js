        ...
        <div className="general-sell-sec">
          ...
          <div className="table-area content-border">
            <ul className="m-toggle-list up-blue fs16">
              <MenuItem>
                <MenuTitle>진행현황<span>예상견적 확인</span></MenuTitle>
                <MenuCont>
          ...
          {bluePop && <div className="stop-cover">
            ...
            <p>전문 평가사의 예상 견적 산정이<br />완료되었습니다.</p>
            <Buttons align="center" marginTop={12}>
              <Button size="sml" line="gray" radius={true} title="견적확인" width={88} height={30} href="/mypage/generalSell_n03Check" nextLink={true} />
            </Buttons>
          </div>}
        </div>
      ...
      <div className="content-wrap">
        ...
        <div className="mypage-state-sec general-sell-sec">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <span>2차 견적 <strong>-</strong> 만원</span>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <Buttons align="center" marginTop={80}>
            ...
            <Button size="big" background="blue80" title="판매 진행" width={160} height={48} onClick={(e) => proceedPopupHandler(e, "fade")} />
          </Buttons>
        </div>
      </div>
      ...
      <RodalPopup show={proceedShow} type={'slideUp'} closedHandler={proceedCloseHandler} mode="normal" size="xs">
        <div className="con-wrap">
          <p>
            ...
            탁송 진행 이후 취소하시면 발생되는<br />
            탁송비는 고객부담으로 처리됩니다.<br />
            계속 진행하시겠습니까?
          </p>
          <Buttons align="center" marginTop={56}>
...
export default GeneralSell_s03
