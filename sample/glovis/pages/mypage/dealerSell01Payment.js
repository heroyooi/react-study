      ...
      <AppLayout>
        ...
        <MobBottomArea active={active1} isFixButton={true}>
          ...
          <Buttons align="center" className="full fixed">
            <Button size="full" background="blue20" color="blue80" title="취소" fontWeight={500} onClick={handleCloseDimm1} />
            <Button size="full" background="blue80" title="신청" fontWeight={500} onClick={(e) => openMPop(e, 'fade')} />
          </Buttons>
        </MobBottomArea>
        ...
        <div className={dimm3 ? "modal-bg active" : "modal-bg"} onClick={handleCloseDimm3}></div>
        <MobBottomArea active={active3} isFixButton={true}>
          <div className="inner">
            <p className="tit1 mb20">증빙자료</p>
            <p className="tit3">대당 이용권 1개월</p>
            <ul className="pay-tx-list border mb16">
        ...
        <div className={dimm4 ? "modal-bg active" : "modal-bg"} onClick={handleCloseDimm4}></div>
        <MobBottomArea active={active4} isFixButton={true}>
          <div className="inner">
...
export default DealerSell01Payment;