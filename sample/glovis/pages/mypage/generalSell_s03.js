        ...
        <div className="general-sell-sec">
          ...
          <div className="table-area content-border">
            <ul className="m-toggle-list up-blue fs16">
              <MenuItem>
                <MenuTitle>진행현황<span>비교견적 진행 중</span></MenuTitle>
                <MenuCont>
          ...
          {bluePop && <div className="stop-cover">
            ...
            <Buttons align="center" marginTop={12}>
              <Button size="sml" line="gray" radius={true} title="입찰현황" width={88} height={30} href="/mypage/generalSell_s03Bid" />
            </Buttons>
          </div>}
        </div>
      </AppLayout>
