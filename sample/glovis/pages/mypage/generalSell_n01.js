...
const GeneralSell_s01 = () => {
  ...
  const [rodalShow1, setRodalShow1, rodalPopupHandler1, modalCloseHandler1] = useRodal(false);//#a2
        ...
        <div className="general-sell-sec">
          ...
          {bluePop && <div className="stop-cover">
            ...
            <Buttons align="center" marginTop={12}>
              <Button size="sml" line="gray" radius={true} title="이어하기" width={88} height={30} href="/sell/freeStep01" nextLink={true} />
            </Buttons>
          </div>}
        </div>
  ...
  return (
    <AppLayout>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <span className="estimate-last">2차 견적 <strong>-</strong> 만원</span>

                  <Button size="mid" line="gray" color="black" radius={true} title="견적 산정 사유 확인" width={140} height={40} marginLeft={32} onClick={(e) => rodalPopupHandler1(e, "fade")}/>
                  {/* #a end */}
                </td>
              </tr>
            </tbody>
          </table>
          <p className="tx-exp-tp3 tx-red80 fr mt16">* 차량 탁송 후 2차 견적 진행 시, 1차 견적 금액과 차이가 발생할 수 있습니다.</p>
      ...
      {/* #a2 팝업추가 start */}
      <RodalPopup show={rodalShow1} type={'fade'} closedHandler={modalCloseHandler1} mode="normal" title="견적 산정 사유 확인" size="small">
        <div className="con-wrap popup-my-ex">  
            <p className="tx-tit">사유</p>    
            <Input placeHolder="" value="" />
            <p className="tx-tit mt40">상세내용</p>
            <Textarea countLimit={400} type="tp1" height={200} />
