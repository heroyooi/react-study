...
export const BuyViewContext = createContext();
/*
  html 변경이력
  03.12 : #a1 수정
...
const ViewA = () => {
  ...
  useEffect(() => {
    ...
    hasMobile
      ? getAnimate("#m-scroll-tab1", "#m-scroll-tab2", "#m-scroll-tab3")
            ...
            <TabCont tabTitle="옵션 정보" id="scroll-tab1" index={0}>
              <div className="content-wrap">
                <table summary="차량 기본정보에 대한 내용" className="table-tp1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>대형차</td>
                      <th>제시번호</th>
                      <td colSpan="3">21363842937{/* #a1 */}</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div className="state-wrap fl">
                  ...
                  <table summary="보험처리 이력 정보에 대한 내용" className="table-tp1">
                    <caption className="away">보험처리 이력</caption>
                    <colgroup>
                      <col width="50%" />
                      <col width="50%" />
                ...
                <div className="state-wrap fr">
                  ...
                  <table summary="성능점검 정보에 대한 내용" className="table-tp1">
                    <caption className="away">성능점검 정보</caption>
                    <colgroup>
                      <col width="15%" />
                      <col width="15%" />
