        ...
        <div className="auctionInfo auction-top-banner">
          <div className="content-wrap">
            ...
            <p className="text-box">
              <span className="date">1월 28일 (화) 09:00 <em>실시간</em></span>
              <span className="bnr-tit">1월 SUV특별전</span>
              <span className="num">출품차량 1,025대</span>
            </p>
          </div>
        </div>

        <div className="auction-info-wrap">
          <h3 className="tit1"><em className="tx-blue80 tx-b">'오토벨 스마트옥션'</em>으로<br />언제 어디서나 편리한 경매참여</h3>
          <TabMenu type="type2" mount={false} defaultTab={seq !== undefined ? Number(seq)-1 : 0}>
              ...
              <div className="content-wrap">
                ...
                <ul className="num-list">
                  <li>
                    ...
                    <p className="exp mt8">
                      이젠 경매장에 직접 방문하지 않아도 온라인으로 경매참여를 할 수 있으며, PC프로그램과 모바일앱만 있으면 경매입찰부터 정산, 탁송신청 까지 모두 가능합니다.
                    </p>
                  </li>
                  <li>
                    <p className="tit2">
                    ...
                    <p className="exp mt8">
                      애플 앱스토어와 구글 플레이스토어에서 ‘오토벨 스마트옥션’을 검색해주세요<br />
                      설치하는 순간 편리한 경매서비스를 누릴 수 있습니다.<br />
                  ...
                  <li>
                    ...
                    <p className="exp mt8">
                      ‘오토벨 증강현실’ 앱을 통해 증강현실 기반 3D 성능점검표 차량위치정보를 제공합니다.<br />
            ...
            <TabCont tabTitle="경매프로그램 설치" id="tab1-2" index={1}>
              <div className="content-wrap">
                <p className="tx-tp1">
                  온라인 경매는 오토벨 스마트옥션 회원만 참여 가능합니다.<br />
                  일반회원은 ‘관전’ 기능만 제공 됩니다.<br />
                ...
                <ul className="text-list">
                  <li>
                    ...
                    <ul className="exp mt16 essential-point">
                      <li><i className="ico-dot"></i>PC응찰프로그램 설치를 위하여 “PC응찰프로그램설치” 를 클릭하여 설치하여 주십시오.</li>
                      <li><i className="ico-dot"></i>PC에 JAVA프로그램이 설치되어 있지 않는 경우 최신 JAVA버전(1.8이상)을 먼저 설치하여 주십시오.</li>
                    </ul>
                    ...
                    <div className="bg-box">
                      <ul className="exp">
                        <li>
                          ...
                          <p className="con">인터넷 익스플로러 > 도구 > 인터넷옵션 > 보안 > 신뢰할 수 있는 사이트 > 사이트 버튼 클릭 > 영역에 웹 사이트 추가 > www.glovisaa.com을 추가하신 후 다시 다운로드를 실행</p>
                        </li>
                        <li>
                  ...
                  <li>
                    ...
                    <ul className="exp mt16 essential-point">
                      <li><i className="ico-dot"></i>경매응찰 앱은 안드로이드 5.0(롤리팝) 이상, iOS 버전 11.0 이상에서 지원됩니다.</li>
                      <li><i className="ico-dot"></i>경매회원은 경매참가 및 마이페이지 기능을 사용 가능하며, 일반회원은 관전모드가 지원됩니다.</li>
                      <li><i className="ico-dot"></i>안드로이드 폰은 <i className="googleplay"></i> , 아이폰은 <i className="appstore"></i>에서 다운받아 설치 가능합니다.</li>
                    </ul>
                        ...
                        <div className="steps-slide">
                          <div className="steps-exp">
                            <ul className="exp essential-point">
                              <li><i className="ico-dot"></i>경매회원 마이페이지 제공</li>
                              <li><i className="ico-dot"></i>당일 및 최근 경매일정 정보 제공</li>
                              <li><i className="ico-dot"></i>모의경매, 튜토리얼 기능 제공</li>
                              <li><i className="ico-dot"></i>부재자응찰, 관심차량 등록</li>
                              <li><i className="ico-dot"></i>지정시간 경매 입찰</li>
                              <li><i className="ico-dot"></i>실시간 경매, Spot 경매 참여</li>
                            </ul>
                          </div>
                        </div>
                        <div className="steps-slide">
                          <div className="steps-exp">
                            <ul className="exp essential-point">
                              <li><i className="ico-dot"></i>마이페이지 : 나의경매, 낙찰현황 등 </li>
                              <li><i className="ico-dot"></i>출품리스트 : 현재 경매참여 중인 Lane의 출품리스트</li>
                              <li><i className="ico-dot"></i>관심차량 : 관심 차량으로 등록 한 차량에 대하여 표시</li>
                              <li><i className="ico-dot"></i>부재자 응찰 : 부재자 응찰 한 차량에 대하여 표시</li>
                              <li><i className="ico-dot"></i>권리 : 자신이 최고 응찰자인 경우 표시</li>
                              <li><i className="ico-dot"></i>낙찰 : 자신이 차량을 낙찰 받은 경우 표시</li>
                              <li><i className="ico-dot"></i>경매선택 : 멀티 Lane에 대하여 경매 참여 Lane 선택</li>
                            </ul>
                            <Buttons align="center" marginTop={16} marginBottom={16}>
                              <Button size="big" background="blue80" radius={true} title="응찰 프로그램 매뉴얼" width={155} height={38} fontWeight={500} fontSize={14}/>
                            </Buttons>
                          </div>
                        </div>
                      </SlideBanner>
            ...
            <TabCont tabTitle="이용안내(회원사)" id="tab1-3" index={2}>
              <div className="auction-process-detail info">
                <div className="content-wrap auction-info">
                  <h3 className="tit2 tx-c">입찰절차</h3>
                  <div className="auction-step">
                    <Steps type={2} contents={['회원가입', '실차확인', '경매참여', '정산반출', '사후처리']} />
                  </div>
                  <ul>
                    <li>
                      <p className="tit4"><em className="tx-blue80 tx-b">01</em> 회원가입</p>
                      <p className="tx-tp2 mt8">회원가입은 서류를 구비하여 경매장에 내방하시어 담당자와 상담 후 <em>절차에 따라 가입할 수 있습니다.</em><br />가입비용은 보증금(300만원) / 연회비(25만원)입니다.</p>
                    </li>
                    <li>
                      <p className="tit4"><em className="tx-blue80 tx-b">02</em> 실차확인</p>
                      <p className="tx-tp2 mt8">출품되는 차량은 홈페이지를 통해 실시간으로 사전확인 할 수 있고, 반드시 경매 당일 내방하시어<br />출품리스트 및 차량에 비치된 성능점검표를 참고하여 실제 차량상태를 확인하시기 바랍니다.</p>
                      <p className="tx-tp3 mt8">&#8251; 오토옥션에 참여하시기 전에 반드시 변경리스트를 참조하시고 차량을 재 확인하시기 바랍니다.</p>
                      <Buttons align="center" marginTop={16}>
                        <Button size="mid" color="blue80" background="blue20" radius={true} title="성능점검 절차보기" width={139} height={38} fontWeight={500} fontSize={14} href="auctionInfoSample"/>
                      </Buttons>
                    </li>
                    <li>
                      <p className="tit4"><em className="tx-blue80 tx-b">03</em> 입찰참여</p>
                      <p className="tx-tp2 mt8">입찰 참여 시 회원카드를 반드시 체크하시고, 회원 본인이 직접 참여 하셔야 합니다.</p>
                    </li>
                    <li>
                      <p className="tit4"><em className="tx-blue80 tx-b">04</em> 정산/반출</p>
                      ...
                      <table summary="낙찰대금 및 탁송료 입금계좌에 대한 내용" className="table-tp1 th-c td-c mt16">
                        ...
                        <tbody>
                          <tr>
                            <th>내용</th>
                            <td>회원사별 전용계좌 입금</td>
                            <td>경매장 공통계좌 입금<br />(KEB 하나은행)</td>
                          </tr>
                          <tr>
                            <th rowSpan="3">계좌<br />번호</th>
                            <td rowSpan="3">회원별 SMS발송<br />(최초 가입 시 전송)</td>
                            <td>분당<br />611-026740-316</td>
                          </tr>
                          <tr>
                            <td>시화<br />611-026740-241</td>
                          </tr>
                          <tr>
                            <td>양산<br />611-026740-266</td>
                          </tr>
                          <tr>
                            <th>비고</th>
                            <td>낙찰대금, 탁송료 등</td>
                            <td>(재)출품수수료,<br />탁송료</td>
                          </tr>
                        </tbody>
                      </table>
                    </li>
                    <li>
                      <p className="tit4"><em className="tx-blue80 tx-b">05</em> 사후처리</p>
                      <p className="tx-tp2 mt8">책임보험은 바로 가입하여 주시고 법정기한인 15일 이내에 명의이전을 해주시기 바랍니다.<br />만약 명의이전 기한이 경과되어 각종 과태료가 발생 시, 회원부담으로 과태료 정산이 이루어지니 유의하시기 바랍니다.<br />또한 차량의 중대한 결함이 발견되어 클레임을 신청할 경우에는 주어진 기한 내에 이의제기를 해주셔야 하며,<br />기한 경과 시에는 클레임 신청이 불가합니다.</p>
                    </li>
                  </ul>
                </div>
                <div className="content-wrap auction-info">
                  <h3 className="tit2 tx-c">경매 수수료 계산</h3>
                  <p className="tx-tp2 tx-c mt16">경매 수수료를 자동으로 계산해보는 예시입니다.<br />차량가격을 입력하시면 수수료를 포함한 입금액을<br />확인하실 수 있습니다.</p>
                      ...
                      <tr>
                        ...
                        <td>
                          <span className="bridge2">
                            <label className="hide" htmlFor="price">차량가격</label>
                            <Input type="text" id="price" width={122} height={40} /><em>만원</em>
                          </span>
                        </td>
                      </tr>
                      <tr>
                        <th>낙찰 수수료</th>
                        <td><span>440,000<em>원</em></span></td>
                      </tr>
                      <tr>
                        <th>총 입금액</th>
                        <td><span className="tx-blue80">10,000,440,000<em>원</em></span></td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <Buttons align="center" marginTop={16}>
                    <Button size="mid" color="blue80" background="blue20" radius={true} title="탁송료 안내" width={100} height={38} fontWeight={500} fontSize={14} onClick={handleConsignFee} />
                  </Buttons>
                </div>
                <div className="content-wrap auction-info">
                  <h3 className="tit2 tx-c">교통편 안내</h3>
                  <p className="tx-tp2 tx-c mt16">회원님들의 원활한 경매참여를 위해<br />경매 당일 1대의 버스를 운영하고 있습니다.</p>
    ...
    <AppLayout>
      <div className="auction-top-banner">
        <div className="content-wrap">
          <h3>다가오는 경매</h3>
          <p className="text-box">
            <span className="date">1월 28일 (화)  09:00</span>실시간
            <em>1월 SUV특별전</em>
            <span className="num">출품차량 1,025대</span>
          </p>
        </div>
      ...
      <div className="auction-info-wrap">
        <h3><span>'오토벨 스마트옥션'</span>으로 언제 어디서나 편리한 경매참여</h3>
        <TabMenu type="type1" mount={false} defaultTab={seq !== undefined ? Number(seq)-1 : 0}>
          <TabCont tabTitle="오토벨 스마트옥션은" id="tab1-1" index={0}>
            <div className="content-wrap">
              <div className="bg-box">
                <p>분당, 시화, 양산 모든 경매센터의 출품차량을 입찰 할 수 있는<br />국내 최대 규모의  온라인 실시간 통합 경매서비스 입니다.</p>
              </div>
              <ul className="num-list">
                <li>
                  <p className="tit">
                  ...
                  <p className="exp">
                    이젠 경매장에 직접 방문하지 않아도 온라인으로 경매참여를 할 수 있으며,<br />
          ...
          <TabCont tabTitle="경매프로그램 설치하기" id="tab1-2" index={1}>
            <div className="content-wrap">
              <div className="bg-box">
                <p>
                  <i className="ico-dot big"></i>온라인 경매는 오토벨 스마트옥션 회원만 참여 가능합니다.<br />
                  <i className="ico-dot big"></i>일반회원은 ‘관전’ 기능만 제공 됩니다.<br />
              ...
              <ul className="text-list">
                <li>
                  ...
                  <Buttons align="center" marginTop={31}>
                    <Button size="big" background="blue80" title="PC 응찰프로그램 설치" width={248} />
                  </Buttons>
                  <div className="line-box">
                    <p>1. PC응찰프로그램이 정상적으로 다운로드 되지 않는 경우<span>인터넷 익스플로러 > 도구 > 인터넷옵션 > 보안 > 신뢰할 수 있는 사이트 > 사이트 버튼 클릭 > 영역에 웹 사이트 추가 >www.glovisaa.com을 추가하신 후 다시 다운로드를 실행</span></p>
                    <p>2. PC응찰프로그램 설치 시 Windows7 이상 PC에서  Windows의 PC보호(Windows Defender Smart Screen)에 의해 설치 차단 되신 경우<span>Defender Smart Screen 필터 해제 또는 차단 화면에서 추가정보 링크를 클릭 후 실행 버튼을 클릭 해주시기 바랍니다.</span></p>
                  </div>
                </li>
                <li>
                  ...
                  <ul className="exp">
                    ...
                    <li>안드로이드 폰은 <i className="googleplay"></i>, 아이폰은 <i className="appstore"></i>에서 다운받아 설치 가능합니다.<span>&#8251; 주의사항: 모바일 응찰 시 스마트폰 기종 및 통신사의 사정으로 경매참여에 장애가 발생 될 수 있습니다.</span></li>
                  </ul>
                </li>
                <li>
                  ...
                  <Buttons align="center" marginTop={31}>
                    <Button size="big" background="blue80" title="최신 JAVA설치" width={248} />
                  </Buttons>
                </li>
                <li>
                ...
                <li>
                  ...
                  <Buttons align="center" marginTop={59}>
                    <Button size="big" background="blue80" title="응찰 프로그램 매뉴얼" width={248} />
                  </Buttons>
                </li>
              </ul>
            </div>
            ...
            <div className="auction-process-detail info">
              <div className="content-wrap">
                <h4><span>STEP {processList[activeProcess - 1].step}</span>{processList[activeProcess - 1].title}</h4>
                {
                  activeProcess === 1 &&
                  <>
                    <p className="con">회원가입은 서류를 구비하여 경매장에 내방하시어 담당자와 상담 후 <em>절차에 따라 가입할 수 있습니다.</em><br />가입비용은 보증금(300만원) / 연회비(25만원)입니다.</p>
                  </>
                }
                {
                  activeProcess === 2 &&
                  <>
                    <p className="con">출품되는 차량은 홈페이지를 통해 실시간으로 사전확인 할 수 있고, 반드시 경매 당일 내방하시어<br />출품리스트 및 차량에 비치된 성능점검표를 참고하여 실제 차량상태를 확인하시기 바랍니다.</p>
                    <span className="tip">&#8251; 오토옥션에 참여하시기 전에 반드시 변경리스트를 참조하시고 차량을 재 확인하시기 바랍니다.</span>
                ...
                {
                  activeProcess === 3 &&
                  <p className="con">입찰 참여 시 회원카드를 반드시 체크하시고, 회원 본인이 직접 참여 하셔야 합니다.</p>
                }
                {
                  activeProcess === 4 &&
                  <>
                    <p className="con"><em>낙찰을 받으신 후 전용계좌로 해당대금을 정산하시면 입금표와 출고증을 교부해 드립니다.</em></p>
                    <table summary="낙찰대금 및 탁송료 입금계좌에 대한 내용" className="table-tp1 th-c td-c">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td rowSpan="3">경매장 공통계좌 입금<br />(KEB 하나은행)</td>
                          <td>분당 611-026740-316</td>
                          <td rowSpan="3">(재)출품수수료,<br />탁송료</td>
                        </tr>
                        <tr>
                          <td>분당 611-026740-316</td>
                        </tr>
                ...
                {
                  activeProcess === 5 &&
                  <p className="con">책임보험은 바로 가입하여 주시고 법정기한인 15일 이내에 명의이전을 해주시기 바랍니다.<br />만약 명의이전 기한이 경과되어 각종 과태료가 발생 시, 회원부담으로 과태료 정산이 이루어지니 유의하시기 바랍니다.<br />또한 차량의 중대한 결함이 발견되어 클레임을 신청할 경우에는 주어진 기한 내에 이의제기를 해주셔야 하며,<br />기한 경과 시에는 클레임 신청이 불가합니다.</p>
                }
              </div>
            </div>
            <div className="content-wrap auction-info">
              <h3>경매 수수료 계산</h3>
              <p>경매 수수료를 자동으로 계산해보는 예시입니다.<br />차량가격을 입력하시면 수수료를 포함한 입금액을 확인하실 수 있습니다.</p>
              <table summary="경매 수수료 계산에 대한 내용" className="table-tp1 input td-r">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <label className="hide" htmlFor="price">차량가격</label>
                      <Input type="text" id="price" width={200} height={40} /><em>만원</em>
                    </td>
                  </tr>
                  <tr>
                    <th>낙찰 수수료</th>
                    <td><span>440,000</span>원</td>
                  </tr>
                  <tr>
                    <th>총 입금액</th>
                    <td><span className="tx-blue80">10,000,440,000</span>원</td>
                  </tr>
                </tbody>
              </table>
              <p className="sub">
                &#8251; 낙찰(상담)수수료 : 낙찰가의 2.2% (최소 110,000원 / 최대 440,000원)<br />
                &#8251; 탁송료 등 부가적인 수수료가 별도로 발생할 수 있습니다.
              </p>
              <Buttons align="right" marginTop={15}>
                <Button size="big" background="blue80" title="탁송료 안내" width={200} onClick={handleConsignFee} />
              </Buttons>
        ...
        <div className="con-wrap popup-auction">
          <TabMenu type="type1" mount={false} defaultTab={tabNum} isSelf={false}>
            <TabCont tabTitle="성능점검절차" id="tab1-1" index={0}>
              <ul className="process-list">
                <li><span>01</span>전체평가</li>
                <li><span>02</span>실내평가</li>
                <li><span>03</span>외관평가</li>
                <li><span>04</span>엔진룸/하체평가</li>
                <li><span>05</span>주행평가</li>
              </ul>
              <ul className="process-detail">
                <li>
                  <h4><span>STEP 01</span>전체평가</h4>
                  <p>자동차의 전체적인 인상 및 자세 확인(표준사양과의 차이점, 개조유무 등 도장색 상태 등)</p>
                </li>
                <li>
                  <h4><span>STEP 02</span>실내평가</h4>
                  <p>실내옵션유무 / 작동성 및 상태확인</p>
                </li>
                <li>
                  <h4><span>STEP 03</span>외관평가</h4>
                  <p>외관상태 및 사고유무 확인 (등화장치, 유리, 휠, 타이어 등)</p>
                </li>
                <li>
                  <h4><span>STEP 04</span>엔진룸/하체평가</h4>
                  <p>엔진, 미션 기타장비의 성능 및 상태점검 (사고흔적, 누수, 누유 각 부의 상태점검)</p>
                </li>
                <li>
                  <h4><span>STEP 05</span>주행평가</h4>
              ...
              <div className="performace-wrap">
                <table summary="기능상태점검에 대한 내용" className="table-tp1 th-c td-c">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td rowSpan="3">평가점<span className="grade">A <em>8</em></span></td>
                    </tr>
                    <tr>
                      <th>기관</th>
                      <td>보통</td>
                ...
                <table summary="기능상태점검에 대한 내용" className="table-tp1 th-c">
                  ...
                  <tbody>
                    <tr>
                      <td>PS이음 / 유격</td>
                      <td><img src="/images/contents/car-img-top2.png" alt="차량상태점검 이미지"/></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <TabCont tabTitle="평가점기준" id="tab1-3" index={2}>
              <div className="estimate-wrap">
                <p className="exp">
                  &#8251; 평가결과는 경매장 자체 평가기준에 의해 결정됩니다.<br />
                ...
                <table summary="사고평가점에 대한 내용" className="table-tp1 th-c">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>C</td>
                      <td>인사이드 패널, 트렁크플로어 패널 사고, 휠하우스 기준 외부골격 사고차량, B등급 사고 2곳 이상</td>
                    </tr>
                    <tr>
                      <td>D</td>
              ...
              <table summary="외관표시기준에 대한 내용" className="table-tp1 th-c td-c">
                ...
                <tbody>
                  <tr>
                    <td>xx</td>
                    <td>교환</td>
                    <td>볼트체결 : 모든 볼트가 풀린 흔적이 있는 경우<br />(단.앞판넬 : 펜더나 본넷중 하나만이라도 조정작업이거나 교환이면 교환)</td>
                  </tr>
                  <tr>
                    <td>pp</td>
                    <td>도장/판금</td>
