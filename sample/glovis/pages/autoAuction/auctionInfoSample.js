              ...
              <TabPane tab="성능점검절차" data-extra="tabpane" key="1">
                <div className="performace-wrap">
                  ...
                  <ul className="process-detail">
                    <li>
                      <h4 className="tit4"><span className="tx-blue80 tx-b">01</span> 전체평가</h4>
                      <p className="tx-tp2 mt8">자동차의 전체적인 인상 및 자세 확인(표준사양과의 차이점, 개조유무 등 도장색 상태 등)</p>
                    </li>
                    <li>
                      <h4 className="tit4"><span className="tx-blue80 tx-b">02</span> 실내평가</h4>
                      <p className="tx-tp2 mt8">실내옵션유무 / 작동성 및 상태확인</p>
                    </li>
                    <li>
                      <h4 className="tit4"><span className="tx-blue80 tx-b">03</span> 외관평가</h4>
                      <p className="tx-tp2 mt8">외관상태 및 사고유무 확인 (등화장치, 유리, 휠, 타이어 등)</p>
                    </li>
                    <li>
                      <h4 className="tit4"><span className="tx-blue80 tx-b">04</span> 엔진룸/하체평가</h4>
                      <p className="tx-tp2 mt8">엔진, 미션 기타장비의 성능 및 상태점검 (사고흔적, 누수, 누유 각 부의 상태점검)</p>
                    </li>
                    <li>
                      <h4 className="tit4"><span className="tx-blue80 tx-b">05</span> 주행평가</h4>
                ...
                <div className="performace-wrap">
                  ...
                  <ul className="car-detail">
                    ...
                    <li>
                      ...
                      <p><img src="/images/contents/car-img-top2.png" alt="차량상태점검 이미지"/></p>
                    </li>
                  </ul>
                </div>
              </TabPane>
              ...
              <TabPane tab="외관표시기준" data-extra="tabpane" key="4">
                <div className="performace-wrap">
                  ...
                  <table summary="외관표시기준에 대한 내용" className="table-tp1 th-c mark-tb mt16">
                    ...
                    <tbody>
                      <tr>
                        <th><span>약어</span><br />표기방법</th>
                        <th>상세설명</th>
                      </tr>
                      <tr>
                        <td><span>xx</span>교환</td>
                        <td>
                      ...
                      <tr>
                        <td><span>pp</span>도장/판금</td>
                        <td><p>육안으로 확인해서 도장이 들어간 것으로 판단한 경우</p></td>
                      </tr>
                      <tr>
                        <td><span>f</span>꺾임</td>
                        <td>
                      ...
                      <tr>
                        <td><span>w</span>용접</td>
                        <td><p>골격부위의 교환수리가 아닌 본래 차량의 부위를 판금 후 용접해서 작업한 경우</p></td>
                      </tr>
                      <tr>
                        <td><span>m</span>조정작업</td>
                        <td>
                      ...
                      <tr>
                        <td><span>x</span>교환필요</td>
                        <td><p>외관의 찌그러짐이나 부식이 심해서 판넬이 찢어져있거나 떨어진 경우</p></td>
                      </tr>
                      <tr>
                        <td><span>P</span>도장필요</td>
                        <td><p>외관의 찌그러짐은 없으나 페인트가 긁혀서 도장을 필요하다고 판단 또는 문콕 개수가 3개 이하</p></td>
                      </tr>
                      <tr>
                        <td><span>Q</span>판금필요</td>
                        <td><p>외관의 찌그러짐이 있을 때나 부식으로 인해 판금이 필요하다고 판단 또는 문콕 개수가 3개 이상</p></td>
                      </tr>
                      <tr>
                        <td><span>A</span>상처</td>
                        <td><p>외관의 상처가 없고 잔기스(광택으로 제거가능)가 있을 시 기재 또는 문콕 개수가 1~2개 이하</p></td>
                      </tr>
                      <tr>
                        <td><span>C</span>부식</td>
                        <td><p>외관의 부식이 진행되고 있거나, 부식으로 인한 구멍이 발생한 경우</p></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              </TabPane>
              <TabPane tab="기능상태 점검항목" data-extra="tabpane" key="5">
                <div className="performace-wrap">
                </div>
              </TabPane>
            </Tabs>
...
export default AuctionInfoSample;