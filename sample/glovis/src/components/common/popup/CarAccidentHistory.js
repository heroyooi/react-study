      ...
      <div className="con-wrap popup-history">
        ...
        <>
          ...
          <div className="content-wrap">
            <ul className="m-toggle-list up-blue">
                  ...
                  <div className="accident-history-cont">
                    ...
                    <TabMenu type="type1" mount={false} isFix={false}>
                      <TabCont tabTitle="내차 사고" id="tab2-1" index={0} className="w-fix-btn">
                        <div className="insurance-history mt16">
                          <h4>2019.06.11</h4>
                          <table summary="내 차 보험(처리)" className="table-tp1 td-r">
                            <caption className="away">내 차 보험(처리)</caption>
                            <colgroup>
                              <col width="50%" />
                              <col width="50%" />
                            </colgroup>
                          ...
                          <span className="partial-loss">분손</span>
                        </div>
                      ...
                      <TabCont tabTitle="상대차 사고" id="tab2-2" index={1}>
                        <div className="insurance-history mt16">
                          ...
                          <table summary="상대 차 보험(처리)" className="table-tp1 td-r">
                            <caption className="away">상대 차 보험(처리)</caption>
                            <colgroup>
                              <col width="50%" />
                              <col width="50%" />
                            </colgroup>
              ...
              <MenuItem>
                ...
                <MenuCont>
                  <div className="accident-history-cont">
                    <ul className="matters-list">
                      <li><strong>중고차 사고이력정보 서비스는 자동차 보험을 취급하는 11개 손해보험사의 자동차 보험수리 지급기록(1996년 이후)에 근거하여 제공하고 있습니다. 따라서 다음과 같은 경우는 중고차 이력정보 서비스를 제공할 수 없습니다.</strong>
                        <ul>
                      ...
                      <li><strong>본 중고차 사고이력 정보는 중고차 품질확인은 위한 보조정보이며 결정적 판단자료로 사용되어서는 아니됩니다. 따라서 정밀한 중고차 품질확인을 윈하시면 차량진단 전문업체의 진단을 받아보시기 바랍니다.</strong></li>
                    </ul>
                  </div>
                </MenuCont>
              </MenuItem>
            ...
            <p>
              보험개발원(<Link href=""><a>www.kidi.or.kr</a></Link>{/* https://www.kidi.or.kr/home/homeIndex.do */})은 보험입법 제176조에 의하여 설립된 보험요율산출기관이며,
              중고차사고이력정보서비스(<Link href=""><a>www.carhistory.or.kr</a></Link>{/* https://www.carhistory.or.kr/main.car?realm= */})는 보험업법시행령 제86조 제1호 근거하여 제공합니다.
            </p>
            <p className="from">
