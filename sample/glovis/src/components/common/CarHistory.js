...
const CarHistory = ({ mode = "apply", event = false }) => {
  const hasMobile = useSelector((state) => state.common.hasMobile);
  const [isMode, setIsMode] = useState(mode); // apply, viewer

  const [isValue1, isView1, handleChange1] = useRadio(3);
  const [isValue2, isView2, handleChange2] = useRadio(2);
  const [isValue3, isView3, handleChange3] = useRadio(1);
  const [isValue4, isView4, handleChange4] = useRadio(3);
  const [isValue5, isView5, handleChange5] = useRadio(2);
  const [isValue6, isView6, handleChange6] = useRadio(1);
            ...
            ? (
              ...
              <div className="accident-history-cont">
                <table summary="사고이력" className="table-tp1">
                  ...
                  <tbody>
                    <tr>
                      <th colSpan="2" className="tx-c">사고이력</th>
                    </tr>
                    <tr>
                      <th>상태</th>
                      <td>없음</td>
                ...
                <table summary="부위별 이상여부 (하단참조)" className="table-tp1">
                  ...
                  <tbody>
                    <tr>
                      <th colSpan="2" className="tx-c">부위별 이상여부 (하단참조)</th>
                    </tr>
                    <tr>
                      <th>외판부위1랭크</th>
                      <td>없음</td>
                ...
                <fieldset className="car-record">
                  ...
                  <table summary="사고 교환 수리 등 이력에 대한 내용" className="table-tp1 th-c td-c">
                    <caption className="hide">사고 <i className="ico-dot big"></i> 교환 <i className="ico-dot big"></i> 수리 등 이력</caption>
                    <colgroup>
                      <col width="12.5%" />
                      <col width="50%" />
                      <col width="12.5%" />
